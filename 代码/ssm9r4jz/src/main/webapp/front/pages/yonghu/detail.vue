<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
					...
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(0, 204, 0, 1)","textAlign":"left"}'>用户账号：</view>
					<view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.yonghuzhanghao}}</view>
				</view>
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 00px rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"rgba(0, 204, 0, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(0, 204, 0, 1)","textAlign":"left"}'>用户姓名：</view>
					...
					<view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.lianxidianhua}}</view>
                				                				...
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 00px rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"rgba(0, 204, 0, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(0, 204, 0, 1)","textAlign":"left"}'>电子邮箱：</view>

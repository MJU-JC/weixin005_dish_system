<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="餐品分类" prop="canpinfenlei">
          <el-input v-model="ruleForm.canpinfenlei" 
              placeholder="餐品分类" clearable  :readonly="ro.canpinfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="餐品分类" prop="canpinfenlei">
              <el-input v-model="ruleForm.canpinfenlei" 
